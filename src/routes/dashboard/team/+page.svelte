...
{#key data?.allPaymentMethods}
	<DialogComp title="+ Add New Team Member" variant="default">
		<form
			action="?/add"
			use:enhance
			id="main"
		...
		>
			...
			<InputComp
				...
				type="textarea"
				name="testimonial"
				placeholder="Add description about the team member"
			/>
	...
	<DataTable {columns} data={data?.allPaymentMethods} search={true} fileName="Team Member" />
{/key}
