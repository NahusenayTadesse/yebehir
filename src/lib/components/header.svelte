...
<header
	class="sticky top-0 z-50 w-full bg-background px-2 py-2 backdrop-blur supports-backdrop-filter:bg-primary lg:px-24 dark:supports-backdrop-filter:bg-primary-foreground"
>
